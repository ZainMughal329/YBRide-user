...
Widget gotAnswerWidget(){
  return Row(
    crossAxisAlignment: CrossAxisAlignment.start,
    children: [
      Expanded(child: Column(
        children: [
          HeadingTextWidget(title: 'We’ve got answers',fontWeight: FontWeight.bold,fontSize: 40,),
          SizedBox(height: 10,),
          SubHeadingTextWidget(title: 'Can’t find what you’re looking for? Visit our Help Center.')
...
Widget gotAnswerWidgetMediumScreen(BuildContext context){
  return Container(
    ...
    child: Column(
      ...
      children: [
        HeadingTextWidget(title: 'We’ve got answers',fontWeight: FontWeight.bold,fontSize: ResponsiveWidget.isLargeScreen(context) ? 40 : 26,),
        SizedBox(height: 10,),
        SubHeadingTextWidget(title: 'Can’t find what you’re looking for? Visit our Help Center.' , textColor: AppColors.blackColor,fontWeight: FontWeight.normal,fontSize: ResponsiveWidget.isLargeScreen(context) ? 16 : 14,),
        SizedBox(height: 50,),
        onTapAnswer(
            'Do you own your cars','Yes! We buy our cars direct from manufacturers like Volkswagen, Hyundai, and Audi. We clean and maintain our vehicles so you can enjoy peace of mind on your trip.'
        ),
