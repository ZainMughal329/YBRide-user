...
Widget InsuranceandAccidentspWidgte(){
    ...
    child: Container(
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            SubHeadingTextWidget(title: 'All Collections > Insurance , Accidents & Incidents'),
            SizedBox(height: 20,),
            Icon(Icons.article_outlined,color: AppColors.buttonColor,size: 50,),
            SizedBox(height: 20,),
            HeadingTextWidget(title: 'Insurance , Accidents & Incidents'),
            SizedBox(height: 20,),
            SubHeadingTextWidget(title: '20 articles'),
            SizedBox(height: 20,),
            Container(
