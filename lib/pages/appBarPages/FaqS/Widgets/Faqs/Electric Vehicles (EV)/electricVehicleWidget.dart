    ...
    child: Container(
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            SubHeadingTextWidget(title: 'All Collections > Electric Vehicles (EV)'),
            SizedBox(height: 20,),
            Icon(Icons.flash_on,color: AppColors.buttonColor,size: 50,),
            SizedBox(height: 20,),
            HeadingTextWidget(title: 'Electric Vehicles (EV)'),
            SizedBox(height: 20,),
            SubHeadingTextWidget(title: '13 articles'),
            SizedBox(height: 20,),
            Container(
