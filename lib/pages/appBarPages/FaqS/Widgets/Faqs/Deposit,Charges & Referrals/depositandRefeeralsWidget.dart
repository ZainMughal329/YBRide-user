...
Widget DepositandrefferalsWidget(){
    ...
    child: Container(
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            SubHeadingTextWidget(title: 'All Collections > Deposits, Charges,Payment & Referrals'),
            SizedBox(height: 20,),
            Icon(Icons.money_rounded,color: AppColors.buttonColor,size: 50,),
            SizedBox(height: 20,),
            HeadingTextWidget(title: 'Deposits, Charges,Payment & Referrals'),
            SizedBox(height: 20,),
            SubHeadingTextWidget(title: '11 articles'),
            SizedBox(height: 20,),
            Container(
