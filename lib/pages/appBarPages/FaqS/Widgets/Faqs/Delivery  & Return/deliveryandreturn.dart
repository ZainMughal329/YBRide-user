...
Widget DeliveryandReturnWidget(){
    ...
    child: Container(
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            SubHeadingTextWidget(title: 'All Collections > Delivery & Return'),
            SizedBox(height: 20,),
            Icon(Icons.location_on,color: AppColors.buttonColor,size: 50,),
            SizedBox(height: 20,),
            HeadingTextWidget(title: 'Delivery & Return'),
            SizedBox(height: 20,),
            SubHeadingTextWidget(title: '29 articles'),
            SizedBox(height: 20,),
            Container(
