  ...
  return Row(
    ...
    children: [
      ...
      Expanded(
          child: Column(
        children: [
          onTapAnswer('Do you own your cars',
          ...
          onTapAnswer('How does the delivery work?',
          ...
          onTapAnswer('How old do I need to be book a kyte?',
              'Our minimum required age is 21 everywhere, except 18 in New York.'),
          onTapAnswer('Can I extend my trip?',
          ...
          onTapAnswer('How does Self Pickups & Return work?',
          ...
          onTapAnswer('What payment method does YBRide accept?',
          ...
          onTapAnswer('What is the cancellation plicy?',
...
Widget gotFrequesntlyaQuestionsWidgetSmall() {
  return Padding(
      ...
      children: [
        ...
        Column(
          ...
          children: [
            HeadingTextWidget(
              height: 1.5,
              title: 'How old do I need to be book a YBCar?',
              textColor: Colors.black,
              fontSize: 17,
              fontWeight: FontWeight.w600,
            ),
        ...
        Column(
          ...
          children: [
            HeadingTextWidget(
              height: 1.5,
              title: 'How does Self Pickups & Return work?',
              textColor: Colors.black,
              fontSize: 17,
              fontWeight: FontWeight.w600,
            ),
        ...
        Column(
          ...
          children: [
            HeadingTextWidget(
              height: 1.5,
              title: 'What payment method does YBRide accept?',
              textColor: Colors.black,
              fontSize: 17,
              fontWeight: FontWeight.w600,
            ),
