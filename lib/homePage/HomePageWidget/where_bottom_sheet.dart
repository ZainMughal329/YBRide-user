...
// List<String> secondarytList = [];
  ...
  cont.state.locationSearchController.addListener(() async{
    final places = await FlutterGooglePlacesSdk('AIzaSyA8mT_fcQoFRNpBokvTjVXsuc-TB9k-leI');
                    ...
                    return cont.state.placeList.value.length == 0
                      ...
                      onTap: () {
                        cont.state.selectedPlace.value = cont
                            .state
                            .placeList.value[index].toString();
                        cont.state.fromAddressSelected.value=true;
                        clearLists();
                        print("selected Place"+cont.state.selectedPlace.value.toString());
                        Navigator.pop(context);
                      },
                    );
                  }),
