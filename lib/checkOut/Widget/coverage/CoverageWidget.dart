        ...
        child: Column(
          ...
          children: [
            ...
            Padding(
              ...
              child: Row(
                children: [
                  HeadingTextWidget(title: '3. Coverage',fontWeight: FontWeight.bold,fontSize: 30,),
                  HeadingTextWidget(
                    title: '*',
            ...
            ListTile(
              ...
              trailing: Obx(() =>
                  _checkBox(state.UnlimitedMiles.value,
                      (value) {
                        if(value==true){
        ...
        child: Column(
          ...
          children: [
            ...
            Padding(
              ...
              child: Row(
                children: [
                  HeadingTextWidget(title: '3. Coverage',fontWeight: FontWeight.bold,fontSize: 23,),
                  HeadingTextWidget(
                    title: '*',
                    fontWeight: FontWeight.bold,
                    fontSize: 23,
            ...
            ListTile(
              leading: Icon(Icons.location_on),
              title: HeadingTextWidget(title: 'Unlimited miles\n\$${state.unlimitedMiles}',fontSize: 15,),
              subtitle: Column(
                mainAxisAlignment: MainAxisAlignment.start,
                crossAxisAlignment: CrossAxisAlignment.start,
                children: [
